...
PRM builds a roadmap of valid states and connects them, then queries paths
through the roadmap. Good for multiple queries in the same environment.
"""
...
class OMPLPRMPlanner:
    ...
    def plan(self, q_start, q_goal, timeout=1.0):
        ...
        planner = og.PRM(self.si)  # type: ignore
